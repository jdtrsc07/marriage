...
@section('content')
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            {{-- <a class="btn btn-success" href="index.html#about">Get Started</a> --}}
            <img src="assets/kasalang bayan/tayona-removebg-preview.png" alt="" style="width: 13%;">
    ...
    <main id="main">
        ...
        <section id="hero" class="hero">
            ...
            <img src="https://images.pexels.com/photos/1670723/pexels-photo-1670723.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="" data-aos="fade-in">

            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h2 data-aos="fade-up" data-aos-delay="100">City Government of Antipolo</h2>
                        <p data-aos="fade-up" data-aos-delay="200">Application for Marriage License</p>
                    </div>
                            ...
                            @if (Route::has('login'))
                                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                    @auth
                                        ...
                                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 underline">Click here to
                                            view you Profile</a>
                                    @else
                ...
                <div class="container">
                    ...
                    <div class="row gy-4 align-items-center features-item">
                        <div class="col-lg-5 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                            <h3>MATAMIS NA I DO</h3>
                            <p>
                                Pinangasiwaan ni Antipolo City Mayor Jun Ynares ang seremonya at matamis na pag-iisang dibdib ng
                                limamput limang nagmamahalan sa ginanap na kasalang bayan ng Brgy Dalig, Hunyo 15, 2019
                                sa Ynares Event Center. Ang amin pong pagbati ng Congratulations and Best Wishes sa mga bagong
                                kasal.
                            </p>
                        ...
                        <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out"
                            ...
                            <div class="image-stack">
                                ...
                                <img src="assets/kasalang bayan/mayor.jpg" alt="" class="stack-front">
                                {{-- <img src="assets/img/features-light-2.jpg" alt="" class="stack-back"> --}}
                                <img src="assets/kasalang bayan/image5.jpg" alt="" class="stack-back">
                            </div>
                        </div>
                    </div><!-- Features Item -->
                    ...
                    <div class="row gy-4 align-items-stretch justify-content-between features-item ">
                        <div class="col-lg-6 d-flex align-items-center features-img-bg" data-aos="zoom-out">
                            ...
                            <img src="assets/kasalang bayan/image4.jpg" class="testimonial-img flex-shrink-0" alt="">
                        </div>

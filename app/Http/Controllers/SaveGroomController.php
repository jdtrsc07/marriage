...
class SaveGroomController extends Controller
{
    ...
    function updateGroom(Request $request)
    {
        $userId = auth()->user()->id;
        $database = SaveGroom::where('user_id', $userId)->first();
        ...
        // $user = Groom::where('user_id', $userId)->first();
        // if ($user) {
        ...
        // }
        //     // updateOrCreate
        // $groom = Groom::firstOrCreate(['user_id' => $userId]);

        // if ($groom->exists) {

        // $groom->lastname = $request->input('lastname');
        // $groom->firstname = $request->input('firstname');
        // $groom->middlename = $request->input('middlename');
        // $groom->update();
        // $groom->update([
        //     'lastname' => $request->input('lastname'),
        //     'firstname' => $request->input('firstname'),
        ...
        //   $groom->firstname = $request->input('firstname');
        //   $groom->middlename = $request->input('middlename');
        //   $groom->save(); // Save the new record to the database
    ...
    function createGroom(Request $request)
    {
